...
from rlinf.models.embodiment.openpi.policies import isaaclab_rc09_policy
...
class LeRobotIsaacLabRC09PegInsertDataConfig(DataConfigFactory):
    ...
    def create(
        ...
        data_transforms = _transforms.Group(
            inputs=[
                isaaclab_rc09_policy.IsaacLabRC09Inputs(
                    model_type=model_config.model_type
                )
            ],
            outputs=[isaaclab_rc09_policy.IsaacLabRC09Outputs()],
        )
